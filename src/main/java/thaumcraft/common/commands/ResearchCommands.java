        ...
        LiteralArgumentBuilder<CommandSource> root = Commands.literal("research")
            ...
            .then(Commands.literal("grant")
                .then(Commands.argument("key", StringArgumentType.string())
                    .executes(ctx -> {
                        ...
                        src.sendSuccess(new TranslationTextComponent("cmd.thaumcraft.research.granted", key), true);
                        return changed;
                    })))
            .then(Commands.literal("reset")
                .executes(ctx -> {
                    ...
                    src.sendSuccess(new TranslationTextComponent("cmd.thaumcraft.research.reset", player.getName().getString()), true);
                    return 1;
                }))
            .then(Commands.literal("reload")
                .executes(ctx -> {
                    ...
                    if (server != null) {
                        ...
                        src.sendSuccess(new TranslationTextComponent("cmd.thaumcraft.research.reload"), true);
                        return 1;
                    }
                    return 0;
                }))
            .then(Commands.literal("open_book")
                .executes(ctx -> {
                    ...
                    if (src.getEntity() instanceof ServerPlayerEntity) {
                        ...
                        src.sendSuccess(new TranslationTextComponent("cmd.thaumcraft.open_book"), false);
                        return 1;
                    }
                    return 0;
                }));
