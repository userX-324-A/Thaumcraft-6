...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> ARCANE_WORKBENCH_CHARGER = registerBlock("arcane_workbench_charger", () -> new thaumcraft.common.blocks.world.ArcaneWorkbenchChargerBlock(magicalDevice().noOcclusion()));
    ...
    public static final RegistryObject<Block> RESEARCH_TABLE = registerBlock("research_table", () -> new ResearchTableBlock(magicalDevice().noOcclusion()));
    public static final RegistryObject<Block> TUBE = registerBlock("tube", () -> new TubeBlock(magicalDevice().noOcclusion()));
    public static final RegistryObject<Block> BELLOWS = registerBlock("bellows", () -> new BellowsBlock(magicalDevice().noOcclusion()));
    public static final RegistryObject<Block> ARCANE_LAMP = registerBlock("arcane_lamp", () -> new ArcaneLampBlock(magicalDevice().lightLevel(s -> 14).noOcclusion()));
    ...
    public static final RegistryObject<Block> SEAL = registerBlock("seal", () -> new SealBlock(magicalDevice().noOcclusion()));
    public static final RegistryObject<Block> BARRIER = registerBlock("barrier", () -> new thaumcraft.common.blocks.world.BarrierBlock(magicalDevice()));
    public static final RegistryObject<Block> PAVING_STONE_BARRIER = registerBlock("paving_stone_barrier", () -> new thaumcraft.common.blocks.world.PavingStoneBarrierBlock(magicalDevice().noOcclusion()));
    ...
    public static final RegistryObject<Block> ESSENTIA_VALVE = registerBlock("essentia_valve", () -> new EssentiaValveBlock(magicalDevice().noOcclusion()));
    public static final RegistryObject<Block> ESSENTIA_TUBE = registerBlock("essentia_tube", () -> new TubeBlock(magicalDevice().noOcclusion()));
    public static final RegistryObject<Block> ESSENTIA_PUMP = registerBlock("essentia_pump", () -> new EssentiaPumpBlock(magicalDevice().noOcclusion()));
    ...
    public static final RegistryObject<Block> ESSENTIA_MIRROR = registerBlock("essentia_mirror", () -> new EssentiaMirrorBlock(magicalDevice().noOcclusion()));
    public static final RegistryObject<Block> ESSENTIA_FILTER = registerBlock("essentia_filter", () -> new EssentiaFilterBlock(magicalDevice().noOcclusion()));
    public static final RegistryObject<Block> ESSENTIA_JAR = registerBlock("essentia_jar", () -> new EssentiaJarBlock(magicalDevice().noOcclusion()));
    public static final RegistryObject<Block> ESSENTIA_JAR_FILLED = registerBlock("essentia_jar_filled", () -> new Block(magicalDevice().noOcclusion()));
    public static final RegistryObject<Block> ESSENTIA_JAR_VOID = registerBlock("essentia_jar_void", () -> new EssentiaJarVoidBlock(magicalDevice().noOcclusion()));
    public static final RegistryObject<Block> ESSENTIA_JAR_BRAIN = registerBlock("essentia_jar_brain", () -> new EssentiaJarBrainBlock(magicalDevice().noOcclusion()));
    public static final RegistryObject<Block> ESSENTIA_CENTRIFUGE = registerBlock("essentia_centrifuge", () -> new EssentiaCentrifugeBlock(magicalDevice()));
    public static final RegistryObject<Block> EVERFULL_URN = registerBlock("everfull_urn", () -> new EverfullUrnBlock(magicalDevice().noOcclusion()));
    ...
    public static final RegistryObject<Block> SPA = registerBlock("spa", () -> new SpaBlock(magicalDevice().noOcclusion()));
    public static final RegistryObject<Block> THAUMATORIUM = registerBlock("thaumatorium", () -> new ThaumatoriumBlock(magicalDevice()));
    public static final RegistryObject<Block> THAUMATORIUM_TOP = registerBlock("thaumatorium_top", () -> new thaumcraft.common.blocks.world.ThaumatoriumTopBlock(magicalDevice().noOcclusion()));
    public static final RegistryObject<Block> VOID_SIPHON = registerBlock("void_siphon", () -> new VoidSiphonBlock(magicalDevice()));
    public static final RegistryObject<Block> BRAIN_IN_A_JAR = registerBlock("brain_in_a_jar", () -> new BrainInAJarBlock(magicalDevice()));
    // Stabilizer uses dedicated block class for infusion stability logic
    public static final RegistryObject<Block> STABILIZER = registerBlock("stabilizer", () -> new StabilizerBlock(magicalDevice().noOcclusion().lightLevel(s -> 4)));
