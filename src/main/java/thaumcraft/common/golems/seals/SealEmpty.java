...
public class SealEmpty implements ISeal {
    private static final ResourceLocation ICON = new ResourceLocation(Thaumcraft.MODID, "items/seals/seal_empty");

    @Override
    public String getKey() { return "thaumcraft:empty"; }
